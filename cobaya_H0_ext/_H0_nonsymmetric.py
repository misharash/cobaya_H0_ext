...
This is a simple generalization of Cobaya's gaussian likelihood for the latest :math:`H_0` measurements,
allowing for different plus and minus errorbars.
"""

from cobaya.likelihoods._base_classes import _H0_prototype


class _H0_nonsymmetric(_H0_prototype):
